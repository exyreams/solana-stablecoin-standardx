Build the Solana Stablecoin Standard

Build the Open-Source SDK & Core Standards for Stablecoins on Solana

About
Superteam Brazil is building open-source standards for Solana — production-ready templates that institutions and builders can fork, customize, and deploy. We've shipped the Solana Vault Standard (SVS), and now we're tackling stablecoins.
...
Reference for Quality & Structure: Solana Vault Standard — follow this repo's patterns for code organization, documentation, and SDK design.
...
Resources
Reference: Solana Vault Standard — quality and structure benchmark

Token-2022: Token Extensions · Permanent Delegate · Transfer Hook · Confidential Transfers

Stablecoin Reference: USDC on Solana · GENIUS Act Compliance

Solana: Anchor Docs · Solana Cookbook
